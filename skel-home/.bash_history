...
ls
sudo dnf install apr apr-util
sudo ./DaVinci_Resolve_18.1.4_Linux.run 
exit
update
myfedora 
ls
...
cd f24/
sudo cp f24-hubertpiatlsarski-Common_Wheat.jpg /usr/share/backgrounds/
cd ../f26/
ls
sudo cp f26-afsilva-DSC06105.jpg /usr/share/backgrounds/
dnf group list --available *desktop
dnf group list --available
dnf group list --available *esktop
dnf group list --available Desktop
...
exit
yay lxsession
yay microsoft visual studio code
